      ...
      <Modal open={open} onClose={handleClose}>
        <Box sx={style} style={{scrollY: "auto"}}>
          ...
          <Typography sx={{ mt: 2 }}>
            ...
            <br/>
            <br/>
            Each day, there is a new target answer. The objective of the game is to guess the target in as few guesses as possible. The game ends in a win if you guess the target within 6 guesses. The game ends in a loss if you guess 6 times without guessing the target.
            <br/>
            <br/>
