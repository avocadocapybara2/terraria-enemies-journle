      ...
      <Modal open={open} onClose={handleClose}>
        <Box sx={style} style={{scrollY: "auto"}}>
          ...
          <Typography sx={{ mt: 2 }}>
            ...
            <br/>
            <br/>
            Each day, there is a new daily correct answer. The objective of the game is to guess the correct answer in as few guesses as possible. The game ends in a win if you guess the correct answer within 6 guesses. The game ends in a loss if you guess 6 times without guessing the correct answer. The daily correct answer changes each day at midnight local time.
            <br/>
            <br/>
